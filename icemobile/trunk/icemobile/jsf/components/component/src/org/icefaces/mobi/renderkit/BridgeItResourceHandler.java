...
import org.icefaces.mobi.utils.Base64;
...
public class BridgeItResourceHandler extends ResourceHandlerWrapper {
    ...
    private class ResourceEntry extends Resource {
        ...
        public boolean userAgentNeedsUpdate(FacesContext context) {
            try {
                Date modifiedSince = MobiJSFUtils.parseHTTPDate(context.getExternalContext().getRequestHeaderMap().get("If-Modified-Since"));
