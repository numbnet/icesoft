...
if (!window.ice.status) {
    (function(namespace) {
        ...
        namespace.DefaultIndicators = function(configuration, container) {
        ...
        namespace.ComponentIndicators = function(workingID, idleID, troubleID, lostID, showPopups, displayHourglassWhenActive) {
            var indicators = [];
