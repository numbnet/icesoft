 ...
 */
package com.icesoft.faces.net.http;

import com.icesoft.net.http.HttpResponse;

public class HttpParser
extends com.icesoft.net.http.HttpParser {
    protected com.icesoft.net.http.HttpRequest createHttpRequest(
