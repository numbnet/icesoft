 ...
 * IceUserObject. </p>
 */
public class IceUserObjectMapWrapper extends IceUserObject implements Serializable{
    public static final String TEXT = "icefaces.text";
     ...
     * @param wrapper
     */
    public IceUserObjectMapWrapper(Map map) {
        super(null);
        this.map = map;
    }
