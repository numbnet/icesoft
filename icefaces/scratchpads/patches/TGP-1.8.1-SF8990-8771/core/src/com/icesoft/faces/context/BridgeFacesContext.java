...
public class BridgeFacesContext extends FacesContext implements ResourceRegistry {
    ...
    public RenderKit getRenderKit() {
        ...
        if (null == viewRoot) {
        	//System.out.println("Null ViewRoot in getRenderKit()");
        	//System.out.println("Null ViewRoot for request URI " + ((javax.servlet.http.HttpServletRequest) FacesContext.getCurrentInstance().getExternalContext().getRequest()).getRequestURI());
            return (null);
        }
        String rootKitId = viewRoot.getRenderKitId();
        if (null == rootKitId) {
        	//System.out.println("Null ViewID in getRenderKit()" + viewRoot);
        	//System.out.println("Null ViewID for request URI " + ((javax.servlet.http.HttpServletRequest) FacesContext.getCurrentInstance().getExternalContext().getRequest()).getRequestURI());
            return (null);
        }
        ...
        //System.out.println("getRenderKit() returning: " + renderKit);
        //System.out.println("getRenderKit() for request URI " + ((javax.servlet.http.HttpServletRequest) FacesContext.getCurrentInstance().getExternalContext().getRequest()).getRequestURI());
