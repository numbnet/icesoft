...
alter table DLFileEntry add extraSettings varchar null;

create table DLFileShortcut (
	fileShortcutId bigint primary key,
...
alter table JournalArticle add description varchar null;
...
alter table Layout add title varchar null;
