...
alter table ShoppingItem add featured_ tinyint;
alter table ShoppingItem add sale_ tinyint;
...
alter table PollsQuestion add expirationDate datetime null;
update PollsQuestion set portletId = '25';
update PollsQuestion set groupId = '-1';

alter table User_ add passwordReset tinyint;
