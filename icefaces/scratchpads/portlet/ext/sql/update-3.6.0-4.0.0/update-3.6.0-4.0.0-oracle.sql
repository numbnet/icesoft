...
alter table Address add street3 varchar2(75) null;
alter table Address add regionId varchar2(75) null;
alter table Address add countryId varchar2(75) null;
alter table Address add typeId varchar2(75) null;
alter table Address add mailing number(1, 0);
alter table Address add primary_ number(1, 0);

alter table BlogsCategory add userName varchar2(75) null;
alter table BlogsCategory add parentCategoryId varchar2(75) null;
alter table BlogsCategory add description varchar2(4000) null;

drop table BlogsComments;

alter table BlogsEntry add groupId varchar2(75) not null default '';
alter table BlogsEntry add userName varchar2(75) null;
...
alter table BookmarksFolder add description varchar2(4000) null;

drop table Contact;
create table Contact_ (
	contactId varchar2(75) not null primary key,
	companyId varchar2(75) not null,
	userId varchar2(75) not null,
	userName varchar2(75) null,
	createDate timestamp null,
...
create table EmailAddress (
	emailAddressId varchar2(75) not null primary key,
	companyId varchar2(75) not null,
	userId varchar2(75) not null,
	userName varchar2(75) null,
	createDate timestamp null,
	...
	typeId varchar2(75) null,
	primary_ number(1, 0)
);

alter table Group_ add className varchar2(75) null;
alter table Group_ add classPK varchar2(75) null;
alter table Group_ add description varchar2(4000) null;
alter table Group_ add availability varchar2(75) null;

create table Groups_Permissions (
	groupId  varchar2(75) not null,
	permissionId varchar2(75) not null
);

alter table IGFolder add description varchar2(4000) null;

alter table JournalArticle add approvedDate timestamp null;
alter table JournalArticle add expired number(1, 0);
...
alter table JournalContentSearch rename column userId to ownerId;
alter table JournalContentSearch add companyId varchar2(100) not null default '';
update JournalContentSearch set companyId = 'liferay.com';

alter table JournalTemplate add langType varchar2(75) null;
update JournalTemplate set langType = 'xsl';

alter table Layout rename column userId to ownerId;
alter table Layout modify name varchar2(4000);
alter table Layout add hidden_ number(1, 0);
alter table Layout add themeId varchar2(75) null;
alter table Layout add colorSchemeId varchar2(75) null;
...
create table ListType (
	listTypeId varchar2(75) not null primary key,
	name varchar2(75) null,
	type_ varchar2(75) null
);
...
alter table MBTopic add categoryId varchar2(75) null;
...
create table Permission_ (
	permissionId varchar2(75) not null primary key,
	companyId varchar2(75) not null,
	actionId varchar2(75) null,
	resourceId varchar2(75) null
);

create table Phone (
	phoneId varchar2(75) not null primary key,
	companyId varchar2(75) not null,
	userId varchar2(75) not null,
	userName varchar2(75) null,
	createDate timestamp null,
...
alter table PortletPreferences rename column userId to ownerId;
...
create table Resource_ (
	resourceId varchar2(25) not null primary key,
	companyId varchar2(25) not null,
	name varchar2(75) null,
	typeId varchar2(15) null,
	scope varchar2(15) null,
	primKey varchar2(200) null
);

alter table Role_ add className varchar2(75) null;
alter table Role_ add classPK varchar2(75) null;
...
alter table ShoppingCategory add groupId varchar2(75) not null default '';
alter table ShoppingCategory add userId varchar2(75) not null default '';
alter table ShoppingCategory add userName varchar2(75) null;
alter table ShoppingCategory add description varchar2(4000) null;

alter table ShoppingCoupon add groupId varchar2(75) not null default '';
alter table ShoppingCoupon add userId varchar2(75) not null default '';
alter table ShoppingCoupon add userName varchar2(75) null;

alter table ShoppingItem add userId varchar2(75) not null default '';
alter table ShoppingItem add userName varchar2(75) null;
...
create table Subscription (
	subscriptionId varchar2(75) not null primary key,
	companyId varchar2(75) not null,
	userId varchar2(75) not null,
	userName varchar2(75) null,
	createDate timestamp null,
...
alter table User_ add contactId varchar2(75) null;
...
create table Website (
	websiteId varchar2(75) not null primary key,
	companyId varchar2(75) not null,
	userId varchar2(75) not null,
	userName varchar2(75) null,
	createDate timestamp null,
...
alter table WikiNode add groupId varchar2(75) not null default '';
