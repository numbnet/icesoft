...
alter table BlogsCategory add description varchar(500);
...
alter table BookmarksFolder add description varchar(500);
...
alter table Group_ add description varchar(500);
...
alter table IGFolder add description varchar(500);
...
-- alter_column_type Layout name varchar(500);
...
alter table ShoppingCategory add description varchar(500);
