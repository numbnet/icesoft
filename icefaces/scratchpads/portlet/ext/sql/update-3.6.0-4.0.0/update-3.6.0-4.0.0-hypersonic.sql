...
alter table BlogsCategory add description longvarchar null;
...
alter table BookmarksFolder add description longvarchar null;
...
alter table Group_ add description longvarchar null;
...
alter table IGFolder add description longvarchar null;
...
alter table JournalContentSearch alter column userId rename to ownerId;
...
alter table Layout alter column userId rename to ownerId;
alter table Layout alter column longvarchar null;;
...
alter table PortletPreferences alter column userId rename to ownerId;
...
alter table ShoppingCategory add description longvarchar null;
