...
alter table BlogsCategory add description varchar null;
...
alter table BookmarksFolder add description varchar null;
...
alter table Group_ add description varchar null;
...
alter table IGFolder add description varchar null;
...
rename column JournalContentSearch.userId to ownerId;
...
rename column Layout.userId to ownerId;
alter table Layout modify name varchar;
...
rename column PortletPreferences.userId to ownerId;
...
alter table ShoppingCategory add description varchar null;
