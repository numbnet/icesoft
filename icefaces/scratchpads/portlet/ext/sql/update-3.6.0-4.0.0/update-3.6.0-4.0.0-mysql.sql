...
alter table Address add mailing tinyint;
alter table Address add primary_ tinyint;

alter table BlogsCategory add userName varchar(75) null;
alter table BlogsCategory add parentCategoryId varchar(75) null;
alter table BlogsCategory add description longtext null;
...
alter table BookmarksFolder add description longtext null;
...
alter table Group_ add description longtext null;
...
alter table IGFolder add description longtext null;

alter table JournalArticle add approvedDate datetime null;
alter table JournalArticle add expired tinyint;
alter table JournalArticle add reviewDate datetime null;
...
alter table JournalContentSearch change column userId ownerId varchar(75);
...
alter table Layout change column userId ownerId varchar(75);
alter table Layout modify name longtext;
alter table Layout add hidden_ tinyint;
...
alter table PortletPreferences change column userId ownerId varchar(75);
...
alter table ShoppingCategory add description longtext null;
...
alter table User_ add modifiedDate datetime null;
