...
alter table BlogsCategory add description long varchar null;
...
alter table BookmarksFolder add description long varchar null;
...
alter table Group_ add description long varchar null;
...
alter table IGFolder add description long varchar null;
...
alter table Layout alter column "name" type long;
...
alter table ShoppingCategory add description long varchar null;
