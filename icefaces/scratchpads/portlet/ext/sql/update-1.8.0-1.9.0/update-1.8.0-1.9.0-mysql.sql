...
alter table JournalArticle add internal_ tinyint;
...
alter table ShoppingOrderItem add description longtext null;
alter table ShoppingOrderItem add properties longtext null;
