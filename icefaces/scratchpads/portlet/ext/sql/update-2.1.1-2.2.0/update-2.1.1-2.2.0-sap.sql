...
alter table ABContact add hoursOfOperation varchar null;
alter table ABContact add timeZoneId varchar(100) null;
alter table ABContact add comments varchar null;

alter table BlogsComments add content varchar null;
...
alter table ShoppingCart add couponIds varchar null;
...
alter table ShoppingOrder add couponIds varchar null;
alter table ShoppingOrder add couponDiscount float;
alter table ShoppingOrder add comments varchar null;
