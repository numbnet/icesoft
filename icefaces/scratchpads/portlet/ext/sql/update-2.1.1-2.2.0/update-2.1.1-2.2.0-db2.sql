...
alter table ABContact add hoursOfOperation varchar(500);
alter table ABContact add timeZoneId varchar(100);
alter table ABContact add comments varchar(500);
...
alter table ShoppingCart add couponIds varchar(500);
...
alter table ShoppingOrder add couponIds varchar(500);
