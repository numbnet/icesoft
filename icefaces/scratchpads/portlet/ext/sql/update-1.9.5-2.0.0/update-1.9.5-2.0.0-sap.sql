...
update Address set createDate = timestamp;
update Address set modifiedDate = timestamp;
...
create table Portlet (
	...
	defaultPreferences varchar null,
	narrow boolean,
	roles varchar null,
	active_ boolean,
...
alter table ShoppingItem add fieldsQuantities varchar null;
