...
alter table Address modify typeId int;
...
alter table Contact_ modify prefixId int;
alter table Contact_ modify suffixId int;
...
alter table EmailAddress modify typeId int;
...
alter table ListType modify listTypeId int;
...
alter table Organization_ modify statusId int;
...
alter table OrgLabor modify typeId int;
...
alter table Phone modify typeId int;
...
alter table Website modify typeId int;
