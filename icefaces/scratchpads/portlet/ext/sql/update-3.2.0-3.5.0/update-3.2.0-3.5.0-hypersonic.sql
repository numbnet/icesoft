...
alter table Layout add type_ longvarchar null;
alter table Layout add typeSettings longvarchar null;
...
alter table ShoppingCart add insure bit null;

alter table ShoppingOrder add insure bit null;
