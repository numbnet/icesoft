...
update JournalArticle set displayDate = timestamp where displayDate is NULL;

alter table Image add modifiedDate timestamp null;
update Image set modifiedDate = timestamp;

alter table Layout add companyId varchar(100) null;
alter table Layout add parentLayoutId varchar(100) null;
alter table Layout add type_ varchar null;
alter table Layout add typeSettings varchar null;
