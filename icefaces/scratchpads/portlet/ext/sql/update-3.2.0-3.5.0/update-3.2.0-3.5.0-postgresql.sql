...
alter table Layout add type_ text null;
alter table Layout add typeSettings text null;
...
alter table ShoppingCart add insure bool null;

alter table ShoppingOrder add insure bool null;
