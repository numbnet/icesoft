...
/**
 * Bean holding time zone specific information. It holds a complete list of the
 * different timezones available on the map and keeps track of which ones have
 * been selected.  A list of these instances and the current state of the selections
 * is maintained in {@link TimeZoneSelections}.
 */
public class TimeZoneWrapper implements Serializable {
    ...
    public TimeZoneWrapper(String id, String mapId,
        ...
        this.dateFormat = TimeZoneSelections.buildDateFormatForTimeZone(TimeZone.getTimeZone(id));
    ...
    public String getDisplayName() {
        ...
        return TimeZoneSelections.displayNameTokenizer(timeZone.getDisplayName());
    }
    ...
    public String getTime() {
        return TimeZoneSelections.formatCurrentTime(dateFormat);
    }
    ...
    /**
     * Implementation to support the Serializable interface.  We'll just
     * keep things simple by relying on the timezone name for our equality
     * check.
     *
     * @param o The object to compare for equality against this instance.
    ...
    public boolean equals(Object o) {
        ...
        TimeZoneWrapper that = (TimeZoneWrapper) o;
    ...
    /**
     * Implementation to support the Serializable interface.  We'll just
     * keep things simple by relying on the timezone name for our hash
     * code.
     */
    public int hashCode() {
