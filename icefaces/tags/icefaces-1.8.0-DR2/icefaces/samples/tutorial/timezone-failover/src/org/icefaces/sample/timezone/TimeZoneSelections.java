...
/**
 * This class is designed to be used as a managed, sesssion-scoped bean that
 * keeps a list of all the valid {@link TimeZoneWrapper)s and their current
 * state for the specific user session.  The {@link TimeZoneBean) uses this
 * class to provide session aware data that can survive a failover across
 * clustered nodes.
 */
public class TimeZoneSelections implements Serializable {

    private static Log log = LogFactory.getLog(TimeZoneSelections.class);

    /**
     * The default {@link java.util.TimeZone} for this host server.
     */
    private TimeZone serverTimeZone;

    /**
     * {@link java.text.DateFormat} used to display the server time.
     */
     ...
     */
    public TimeZoneSelections() {
        init();
    }

    /**
     * Initializes this TimeZoneSelections's properties.
     */
    private void init() {
    ...
    public ArrayList getCheckedTimeZoneList() {
        ...
        Iterator zones = allTimeZoneList.iterator();
        while (zones.hasNext()) {
            TimeZoneWrapper wrapper = (TimeZoneWrapper) zones.next();
            if (wrapper.getCurrentlyShowing()) {
                showing.add(wrapper);
            }
        }
        return showing;
    ...
    public void updateSelectedTimezone() {
    ...
    public void updatedCheckedTimezones(ValueChangeEvent event) {
    ...
    public boolean equals(Object o) {
        ...
        TimeZoneSelections that = (TimeZoneSelections) o;

        if (allTimeZoneList != null ? !allTimeZoneList.equals(that.allTimeZoneList) : that.allTimeZoneList != null) {
            return false;
        }
    ...
    public int hashCode() {
        return allTimeZoneList != null ? allTimeZoneList.hashCode() : 0;
    }
