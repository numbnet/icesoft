...
implements HttpConnection {
    private NioHttpConnectionAcceptor nioHttpConnectionAcceptor;
    ...
    public NioHttpConnection(
        ...
        this.nioHttpConnectionAcceptor = nioHttpConnectionAcceptor;
        inputStream =
    ...
    public void close() {
        nioHttpConnectionAcceptor.closeChannel(selectionKey);
        super.close();
    }
