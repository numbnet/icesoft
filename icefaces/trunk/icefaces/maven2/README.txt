...
Then in your application pom, you simply have to include your icefaces-compat and possibly icefaces-facelets dependencies,(which have dependency on icefaces, which has dependency on jsf version)
