 ...
 */
package com.icesoft.util.net.messaging.jms;

import com.icesoft.util.net.messaging.MessageServiceConfiguration;
...
extends MessageServiceConfiguration {
     ...
     *   use:
     *   <code>com.icesoft.util.net.messaging.jms.topicConnectionFactoryName</code>.
     * </p>
     */
    public static final String TOPIC_CONNECTION_FACTORY_NAME =
        "com.icesoft.util.net.messaging.jms.topicConnectionFactoryName";
    /**
     * <p>
     *   The environment property name for the topic name prefix to use when
     *   looking up the topics:
     *   <code>com.icesoft.util.net.messaging.jms.topicNamePrefix</code>.
     * </p>
     */
