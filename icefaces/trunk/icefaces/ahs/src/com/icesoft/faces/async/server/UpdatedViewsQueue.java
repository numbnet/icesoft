...
public class UpdatedViewsQueue {
    ...
    private UpdatedViewsQueueManager updatedViewsQueueManager;

    public UpdatedViewsQueue(
        final String iceFacesId,
        final UpdatedViewsQueueManager updatedViewsQueueManager)
    throws IllegalArgumentException {
        ...
        if (updatedViewsQueueManager != null) {
            this.updatedViewsQueueManager = updatedViewsQueueManager;
            this.size =
                this.updatedViewsQueueManager.getUpdatedViewsQueueSize();
            this.threshold =
                this.updatedViewsQueueManager.getUpdatedViewsQueueThreshold();
        }
    ...
    throws UpdatedViewsQueueExceededException {
        if (updatedViews != null &&
            ...
            if (updatedViewsQueueManager != null && getSize() == size) {
    ...
    public void purge(
        ...
        if (sequenceNumber > 0) {
            ...
            while (_updatedViewsIterator.hasNext()) {
                ...
                if (updatedViewsQueueManager != null) {
                    updatedViewsQueueManager.purged(
            ...
            if (updatedViewsQueueManager != null &&
                ...
                updatedViewsQueueManager.publishPurgeMap(iceFacesId);
            }
        }
    }
