...
public class PanelDividerRenderer extends DomBasicRenderer{
    ...
    throws IOException {
        ...
        container.setAttribute(HTML.CLASS_ATTR, CSS_DEFAULT.PANEL_DIVIDER_BASE);
        dividerContainer.setAttribute(HTML.CLASS_ATTR, CSS_DEFAULT.PANEL_DIVIDER_SPLITER);
    ...
    void renderPane(FacesContext facesContext,
        ...
        if (isFrist) {
            ...
            pane.setAttribute(HTML.CLASS_ATTR, CSS_DEFAULT.PANEL_DIVIDER_LEFT_PANE);
        } else {
            facet = panelDivider.getSecondFacet();
            pane.setAttribute(HTML.ID_ATTR, clientId+= "Second");    
            pane.setAttribute(HTML.CLASS_ATTR, CSS_DEFAULT.PANEL_DIVIDER_RIGHT_PANE);            
        }
        if (facet == null ) {
