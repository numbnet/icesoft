...
public class SelectInputTextRenderer extends DomBasicInputRenderer {
    ...
    private static final String[] passThruAttributes = new String[]{ HTML.ACCESSKEY_ATTR,  HTML.ALT_ATTR,  HTML.DIR_ATTR,  HTML.LANG_ATTR,  HTML.ONCHANGE_ATTR,  HTML.ONCLICK_ATTR,  HTML.ONDBLCLICK_ATTR,   HTML.ONKEYPRESS_ATTR,   HTML.ONMOUSEDOWN_ATTR,  HTML.ONMOUSEMOVE_ATTR,  HTML.ONMOUSEOUT_ATTR,  HTML.ONMOUSEOVER_ATTR,  HTML.ONMOUSEUP_ATTR,  HTML.ONSELECT_ATTR, HTML.SIZE_ATTR,  HTML.STYLE_ATTR, HTML.TITLE_ATTR,  HTML.WIDTH_ATTR };
       ...
       //     String scriptCode = "window.onLoad(function(){" + call + "});";
         //   Node node = domContext.createTextNode(scriptCode);
          ...
          //  root.appendChild(script);
            ...
            PassThruAttributeRenderer.renderHtmlAttributes(facesContext, uiComponent, input, null, new String[]{HTML.MAXLENGTH_ATTR});
