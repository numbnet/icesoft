...
public class TableRenderer extends DomBasicRenderer {
    ...
    public void decode(FacesContext facesContext, UIComponent uiComponent) {
        ...
        String scrollPosition = (String) facesContext.getExternalContext().getRequestParameterMap().get(scrollPositionParameter);
    ...
    public void encodeBegin(FacesContext facesContext, UIComponent uiComponent)
        ...
        if (isScrollable(uiComponent)) {
            ...
            ValueBinding vb = uiComponent.getValueBinding("scrollPosition");
            int scrollPosition = vb == null ? 0 : ((Integer) vb.getValue(facesContext)).intValue();
