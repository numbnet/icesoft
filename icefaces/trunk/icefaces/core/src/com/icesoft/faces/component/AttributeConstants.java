...
public class AttributeConstants {
    ...
    public final static int H_COMMANDBUTTON = 73;

    public final static int H_COMMANDLINK = 74;

    public final static int H_DATATABLE = 75;

    public final static int H_FORMFORM = 76;

    public final static int H_GRAPHICIMAGE = 77;

    public final static int H_INPUTHIDDEN = 78;

    public final static int H_INPUTSECRET = 79;

    public final static int H_INPUTTEXT = 80;

    public final static int H_INPUTTEXTAREA = 81;

    public final static int H_MESSAGEMESSAGE = 82;

    public final static int H_MESSAGESMESSAGES = 83;

    public final static int H_OUTPUTFORMAT = 84;

    public final static int H_OUTPUTLABEL = 85;

    public final static int H_OUTPUTLINK = 86;

    public final static int H_OUTPUTTEXT = 87;

    public final static int H_PANELGRID = 88;

    public final static int H_PANELGROUP = 89;

    public final static int H_SELECTBOOLEANCHECKBOX = 90;

    public final static int H_SELECTMANYCHECKBOX = 91;

    public final static int H_SELECTMANYLISTBOX = 92;

    public final static int H_SELECTMANYMENU = 93;

    public final static int H_SELECTONELISTBOX = 94;

    public final static int H_SELECTONEMENU = 95;

    public final static int H_SELECTONERADIO = 96;

    private final static Object[] attributes = new Object[97];
    static{
