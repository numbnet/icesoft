...
implements HttpConnection {
    ...
    public IoHttpConnection(
        ...
        super(ioHttpConnectionAcceptor);
        this.socket = socket;
        try {
    ...
    public void close() {
        ((IoHttpConnectionAcceptor)httpConnectionAcceptor).closeSocket(socket);
        super.close();
    }
    ...
    public void reset() {
        super.reset();
        if (!closeRequested) {
            ((IoHttpConnectionAcceptor)httpConnectionAcceptor).handle(socket);
        }
    }
}
