...
implements Handler, Runnable {
    ...
    public ProcessHandler(
        final ExecuteQueue executeQueue, final PushServer pushServer)
    throws IllegalArgumentException {
        super(executeQueue, pushServer);
    }
            ...
            switch (state) {
                ...
                case STATE_PROCESSING_REQUEST :
                    ...
                    ProcessHandler _processHandler =
                        (ProcessHandler)
                            pushServer.getSessionManager().getRequestManager().
                                pull(iceFacesIdSet);
                ...
                case STATE_WAITING_FOR_RESPONSE :
                    ...
                    if (pushServer.getSessionManager().
        ...
        switch (state) {
            case STATE_RESPONSE_IS_READY :
                ...
                WriteHandler _writeHandler =
                    new WriteHandler(executeQueue, pushServer);
    ...
    private boolean acceptable() {
        HttpRequest _httpRequest =
            (HttpRequest)httpConnection.getTransaction().getHttpRequest();
    ...
    private void addEntityBody() {
        HttpResponse _httpResponse =
            (HttpResponse)httpConnection.getTransaction().getHttpResponse();
