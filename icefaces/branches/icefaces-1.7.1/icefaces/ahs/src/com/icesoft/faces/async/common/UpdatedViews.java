...
implements Comparable {
    ...
    throws IllegalArgumentException {
        ...
        if (updatedViewsSet == null) {
            throw new IllegalArgumentException("updatedViewsSet is null");
        }
        if (updatedViewsSet.isEmpty()) {
            throw new IllegalArgumentException("updatedViewsSet is empty");
        }
