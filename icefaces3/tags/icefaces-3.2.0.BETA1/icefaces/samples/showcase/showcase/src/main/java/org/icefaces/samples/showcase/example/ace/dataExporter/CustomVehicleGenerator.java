...
public class CustomVehicleGenerator implements Serializable
{
    ...
    public ArrayList<CustomCar> addCarsToList(int quantityToAdd, ArrayList<CustomCar> list)
    {
        ...
        for(int i = 0; i< quantityToAdd; i++)
        {
            ...
            CustomCar car = new CustomCar(currentListSize+position+1, copyReference.getName(),
                                      ...
                                      copyReference.getCost(), generateExpansionData());
            list.add(car);
    ...
    private ArrayList<CustomCar> getPredefinedCars()
    {
        ...
        listWithCars.add(new CustomCar(1,"Enduro","Van",15383,10,17.86,6617.17, generateExpansionData()));
        listWithCars.add(new CustomCar(2,"Tomcat","Bus",7331,15,16.65,31464.24, generateExpansionData()));
        listWithCars.add(new CustomCar(3,"Doublecharge","Pickup",5333,15,17.84,10922.73, generateExpansionData()));
        listWithCars.add(new CustomCar(4,"Swordfish","Bus",10956,5,5.17,6019.83, generateExpansionData()));
        listWithCars.add(new CustomCar(5,"Iguana","Pickup",1696,10,9.43,19736.16, generateExpansionData()));
        listWithCars.add(new CustomCar(6,"Dart","Motorcycle",9261,15,12.85,37947.84, generateExpansionData()));
        listWithCars.add(new CustomCar(7,"Pisces","Luxury",7846,10,15.13,19235.2, generateExpansionData()));
        listWithCars.add(new CustomCar(8,"Flash","Mid-Size",11499,10,12.74,29942.38, generateExpansionData()));
        
        listWithCars.add(new CustomCar(9,"Tomcat","Mid-Size",10766,15,7.04,14342.74, generateExpansionData()));
        listWithCars.add(new CustomCar(10,"Pisces","Subcompact",2082,10,13.38,8015.01, generateExpansionData()));
        listWithCars.add(new CustomCar(11,"Superflash","Subcompact",14959,5,3.91,31941.1, generateExpansionData()));
        listWithCars.add(new CustomCar(12,"Husky","Mid-Size",14334,15,13.98,9303.69, generateExpansionData()));
        listWithCars.add(new CustomCar(13,"Gazelle","Semi-Truck",14248,5,8.64,9285.57, generateExpansionData()));
        
        listWithCars.add(new CustomCar(14,"Superflash","Luxury",3037,15,8.44,36154.13, generateExpansionData()));
        listWithCars.add(new CustomCar(15,"Enduro","Subcompact",4997,5,6.02,31221.48, generateExpansionData()));
        listWithCars.add(new CustomCar(16,"Tomcat","Pickup",4555,10,4.06,35895.53, generateExpansionData()));
        listWithCars.add(new CustomCar(17,"Courier","Pickup",9848,10,16.15,27343.38, generateExpansionData()));
        listWithCars.add(new CustomCar(18,"Enduro","Motorcycle",5725,5,14.17,34430.44, generateExpansionData()));
        
        listWithCars.add(new CustomCar(19,"Swordfish","Luxury",1466,10,11.72,19266.56, generateExpansionData()));
        listWithCars.add(new CustomCar(20,"Tomcat","Station Wagon",15576,10,15.3,16844.05, generateExpansionData()));
        listWithCars.add(new CustomCar(21,"Iguana","Van",10973,15,3.77,33369.32, generateExpansionData()));
        listWithCars.add(new CustomCar(22,"Doublecharge","Pickup",9414,10,6.37,19370.61, generateExpansionData()));
        listWithCars.add(new CustomCar(23,"Hawk","Motorcycle",8545,5,7.98,39124.1, generateExpansionData()));
        
        listWithCars.add(new CustomCar(24,"Hawk","Subcompact",1853,10,12.54,36068.19, generateExpansionData()));
        listWithCars.add(new CustomCar(25,"Tomcat","Subcompact",12785,10,12.97,26141.79, generateExpansionData()));
        listWithCars.add(new CustomCar(26,"Hawk","Semi-Truck",12453,10,10.4,13654.1, generateExpansionData()));
        listWithCars.add(new CustomCar(27,"Doublecharge","Van",11952,10,17.58,22599.82, generateExpansionData()));
        listWithCars.add(new CustomCar(28,"Flash","Semi-Truck",6107,5,8.48,26096.26, generateExpansionData()));
        
        listWithCars.add(new CustomCar(29,"Courier","Bus",8187,5,4.25,25470.63, generateExpansionData()));
        listWithCars.add(new CustomCar(30,"Dart","Motorcycle",7177,10,12.16,35394.23, generateExpansionData()));
   ...
   //////////////// IT WAS REMOVED FROM PUBLIC CLASS INTERFACE DUE TO QC TEST REQUIREMENTS////////////
    ...
    private CustomCar getRandomCar()
    {
        CustomCar randomCar = new CustomCar(randomizer.nextInt(10000000), generateName(),
                                  ...
                                  generateMPG(), generateCost(), generateExpansionData());
        return randomCar;
    }
