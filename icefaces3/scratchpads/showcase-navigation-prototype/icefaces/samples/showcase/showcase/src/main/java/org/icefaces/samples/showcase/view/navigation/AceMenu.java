...
@Menu(
        title = "menu.ace.title", menuLinks = {
                @MenuLink(title = "menu.ace.accordionpanel.title", 
                                isDefault = true,
                                exampleBeanName = AccordionPanelBean.BEAN_NAME),
                @MenuLink(title = "menu.ace.checkboxButton.title",
                                exampleBeanName = CheckboxButtonBean.BEAN_NAME),
                @MenuLink(title = "menu.ace.confirmationdialog.title",
                ...
                @MenuLink(title = "menu.ace.dialog.title",
                                exampleBeanName = DialogBean.BEAN_NAME),
                @MenuLink(title = "menu.ace.dragDrop.title",
                ...
                @MenuLink(title = "menu.ace.linkButton.title",
                                exampleBeanName = LinkButtonBean.BEAN_NAME),
                @MenuLink(title = "menu.ace.maskedEntry.title",
                ...
                @MenuLink(title = "menu.ace.notificationpanel.title",
                                exampleBeanName = NotificationPanelBean.BEAN_NAME),
                @MenuLink(title = "menu.ace.panel.title",
                                exampleBeanName = PanelBean.BEAN_NAME),
                @MenuLink(title = "menu.ace.progressbar.title",
                                exampleBeanName = ProgressBarBean.BEAN_NAME),
                @MenuLink(title = "menu.ace.pushButton.title",
                                exampleBeanName = PushButtonBean.BEAN_NAME),
                @MenuLink(title = "menu.ace.resizable.title",
                ...
                @MenuLink(title = "menu.ace.tooltip.title",
                                exampleBeanName = TooltipOverviewBean.BEAN_NAME)
        })
