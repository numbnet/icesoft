...
(function($) {
    ...
    $.fn.emptyForce = function() {
      for ( var i = 0, elem; (elem = $(this)[i]) != null; i++ ) {
        ...
        if ( elem.nodeType === 1 ) {
          ice.ace.jq.cleanData( elem.getElementsByTagName("*") );
        }
        ...
        if ($.jqplot.config.catchErrors) {
            try {
                ...
                $('#'+target).append('<div class="jqplot-error-message">'+msg+'</div>')
                    ...
                    .css('style.fontStyle', $.jqplot.config.errorFontStyle)
    ...
    function jqPlot() {
        ...
        this.init = function(target, data, options) {
            ...
            if (options.dataRenderer && ice.ace.jq.isFunction(options.dataRenderer)) {
            ...
            if (options.noDataIndicator && ice.ace.jq.isPlainObject(options.noDataIndicator)) {
                $.extend(true, this.noDataIndicator, options.noDataIndicator);
            }
            
            if (data == null || ice.ace.jq.isArray(data) == false || data.length == 0 || ice.ace.jq.isArray(data[0]) == false || data[0].length == 0) {
        ...
        this.destroy = function() {
            ...
            // have to directly set it to null, bypassing ice.ace.jq.
            this.target.empty();
        ...
        this.onClick = function(ev) {
            ...
            var evt = ice.ace.jq.Event('jqplotClick');
            evt.pageX = ev.pageX;
            evt.pageY = ev.pageY;
        ...
        this.onDblClick = function(ev) {
            ...
            var p = ev.data.plot;
            var neighbor = checkIntersection(positions.gridPos, p);
            var evt = ice.ace.jq.Event('jqplotDblClick');
            evt.pageX = ev.pageX;
            evt.pageY = ev.pageY;
            $(this).trigger(evt, [positions.gridPos, positions.dataPos, neighbor, p]);
        };
        ...
        this.onMouseDown = function(ev) {
            ...
            var p = ev.data.plot;
            var neighbor = checkIntersection(positions.gridPos, p);
            var evt = ice.ace.jq.Event('jqplotMouseDown');
            evt.pageX = ev.pageX;
            evt.pageY = ev.pageY;
            $(this).trigger(evt, [positions.gridPos, positions.dataPos, neighbor, p]);
        };
        ...
        this.onMouseUp = function(ev) {
            var positions = getEventPosition(ev);
            var evt = ice.ace.jq.Event('jqplotMouseUp');
            evt.pageX = ev.pageX;
            evt.pageY = ev.pageY;
        ...
        this.onRightClick = function(ev) {
            ...
            if (p.captureRightClick) {
                if (ev.which == 3) {
                var evt = ice.ace.jq.Event('jqplotRightClick');
                evt.pageX = ev.pageX;
                evt.pageY = ev.pageY;
                    $(this).trigger(evt, [positions.gridPos, positions.dataPos, neighbor, p]);
                }
        ...
        this.onMouseMove = function(ev) {
            ...
            var p = ev.data.plot;
            var neighbor = checkIntersection(positions.gridPos, p);
            var evt = ice.ace.jq.Event('jqplotMouseMove');
            evt.pageX = ev.pageX;
            evt.pageY = ev.pageY;
            $(this).trigger(evt, [positions.gridPos, positions.dataPos, neighbor, p]);
        };
        ...
        this.onMouseEnter = function(ev) {
            var positions = getEventPosition(ev);
            var p = ev.data.plot;
            var evt = ice.ace.jq.Event('jqplotMouseEnter');
            evt.pageX = ev.pageX;
            evt.pageY = ev.pageY;
        ...
        this.onMouseLeave = function(ev) {
            var positions = getEventPosition(ev);
            var p = ev.data.plot;
            var evt = ice.ace.jq.Event('jqplotMouseLeave');
            evt.pageX = ev.pageX;
            evt.pageY = ev.pageY;
            evt.relatedTarget = ev.relatedTarget;
            $(this).trigger(evt, [positions.gridPos, positions.dataPos, null, p]);
