...
@ComponentExample(
        ...
        title = "example.ace.dateentry.timeentry.title",
        description = "example.ace.dateentry.timeentry.description",
        example = "/resources/examples/ace/date/datetimeentry.xhtml"
)
@ExampleResources(
        resources ={
            // xhtml
            @ExampleResource(type = ResourceType.xhtml,
                    title="datetimeentry.xhtml",
                    resource = "/resources/examples/ace/date/datetimeentry.xhtml"),
            // Java Source
            @ExampleResource(type = ResourceType.java,
                    title="DateTimeBean.java",
                    resource = "/WEB-INF/classes/org/icefaces/samples/showcase/example/ace/date/DateTimeBean.java")
        }
)
@ManagedBean(name= DateTimeBean.BEAN_NAME)
@CustomScoped(value = "#{window}")
public class DateTimeBean extends ComponentExampleImpl<DateTimeBean> implements Serializable {
    ...
    private static final String PATTERN_BOTH = PATTERN_DATE + " " + PATTERN_TIME;
    ...
    public DateTimeBean() {
        ...
        Calendar calendar = Calendar.getInstance(TimeZone.getTimeZone("Canada/Mountain"), Locale.getDefault());
