...
public class ConfirmationDialogMeta extends UIPanelMeta {
	...
	@Property(tlddoc="Effect to use when showing the dialog. Standard jQuery effects are supported (Some effects are not supported in IE7, see wiki page for more information).")
	private String showEffect;
	
	@Property(tlddoc="Effect to use when hiding the dialog. Standard jQuery effects are supported, except for 'pulsate' (Some effects are not supported in IE browsers, see wiki page for more information).")
