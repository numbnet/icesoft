...
(function( $, undefined ) {
    ...
    $.widget( "ui.accordion", {
        ...
        _toggleComplete: function( data ) {
            ...
            if ( toHide.length ) {
                if (toHide.parent() && toHide.parent()[0]) // ICE-7497, prevents JS error
    ...
    $.extend(Datepicker.prototype, {
        ...
        _generateHTML: function(inst) {
            var maxDraw, prevText, prev, nextText, next, currentText, gotoDate,
                ...
                printDate, dRow, tbody, daySettings, otherMonth, unselectable, ariaEnabled,
                presentationRole, columnHeaderRole, gridCellRole,
                tempDate = new Date(),
            ...
            defaultDate = this._getDefaultDate(inst);
            html = "";
            ariaEnabled = inst.settings.ariaEnabled;
            presentationRole = ariaEnabled ? " role='presentation'" : "";
            columnheaderRole = ariaEnabled ? " role='columnheader'" : "";
            gridcellRole = ariaEnabled ? " role='gridcell'" : '';
            dow;
    ...
    $.widget( "ui.slider", $.ui.mouse, {
        ...
        _create: function() {
            ...
            if (this.options.ariaEnabled) {
                handleAria += " role='slider'";
                handleAria += " aria-orientation='" + this.orientation + "'";
                handleAria += " aria-valuemax='" + this._valueMax() + "'";
                handleAria += " aria-valuemin='" + this._valueMin() + "'";
                handleAria += " aria-valuenow='" + this._value() + "'";
                handleAria += " aria-valuetext='" + this._value() + "'";
            }
        ...
        _createHandles: function() {
            var i, handleCount,
                ...
                handle = "<a class='ui-slider-handle ui-state-default ui-corner-all' href='#' " + this.handleAria + "></a>",
                handles = [];
