...
<f:view>
	<div align="left">Sell Item JSF - A Spring Web Flow and ICEfaces Sample</div>
	<hr>
	<div align="left">
		<p>
			<h:form>
        ...
        <p>
			Using ICEfaces components in this sample application demonstrates the following:
		</p>
		<ul>
			<li>Add Ajax functionality to the web application simply, with no visible Javascript</li>
			<li>Reduce the number of page transitions required in an application</li>
            <li>Increase access to server side business logic throughout each page, not just during transitions,
            for richer interactivity</li>
            <li>No modification of existing Webflow configuration required</li>
        </ul>
    </div>
	<hr/>
</f:view>
