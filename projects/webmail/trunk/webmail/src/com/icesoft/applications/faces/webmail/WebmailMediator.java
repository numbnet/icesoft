...
public class WebmailMediator implements
    ...
    /**
     * Starts webmail with a UserBean configured and verified by the Login
     * manager.  All other manager classes are initialized by this method.
     *
     * @return navigation command
     */
    public String startWebmail() {
        ...
        if (loginManager != null) {
            ...
            loginManager.init();
            loginBean = loginManager.getLoginBeanFactory().getLoginBean();
        }
        ...
        if (LoginBean.LOGIN_SUCCESS.equals(
            ...
            // init contact manager from db.
            if (contactManager != null) {
                contactManager.setMediator(this);
                contactManager.init();
            }

            // init tasks manager from db.
            if (tasksManager != null) {
                tasksManager.setMediator(this);
                tasksManager.init();
            }

            // init navigation nmanager, builds tree from difference manager data
            if (navigationManager != null) {
                navigationManager.setMediator(this);
                navigationManager.init();
            }

            // init mail manager, loads accounts from database and setup map
            if (mailManager != null) {
                mailManager.setMediator(this);
                mailManager.init();
            }
