...
public class Auctionitem implements java.io.Serializable {
    ...
    @Transient
    public List<Bid> getViewbids(){
    	//just get the most recent 5 bids if list > size=5
    	if (bids.size()<=5)return bids;
    	List<Bid> tempList = new ArrayList<Bid>();
    	for (int i=bids.size()-1; i >(bids.size()-5); i--){
    		tempList.add(bids.get(i));
    	}
    	return tempList;
    }
