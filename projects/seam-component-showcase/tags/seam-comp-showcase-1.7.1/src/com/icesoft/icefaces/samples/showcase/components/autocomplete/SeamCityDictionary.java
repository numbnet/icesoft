...
import org.icefaces.application.showcase.view.bean.examples.component.selectInputText.CityDictionary;
 ...
 *
 * @see SelectInputController
 */
@Name("cityDictionary")
@Scope(ScopeType.APPLICATION)
@Synchronized
@AutoCreate
public class SeamCityDictionary extends CityDictionary{
