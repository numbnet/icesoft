...
import org.icefaces.application.showcase.view.bean.examples.component.selection.SelectionTagsBean;
...
@Scope(PAGE)
@Name("selectionTags")
public class SeamSelectionTagsBean extends SelectionTagsBean{
