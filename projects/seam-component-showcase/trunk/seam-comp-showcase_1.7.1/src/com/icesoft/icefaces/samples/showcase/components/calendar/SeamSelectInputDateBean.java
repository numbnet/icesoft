...
import org.icefaces.application.showcase.view.bean.examples.component.selectInputDate.SelectInputDateBean;
...
@Scope(PAGE)
@Name("dateSelect")
public class SeamSelectInputDateBean extends SelectInputDateBean{
