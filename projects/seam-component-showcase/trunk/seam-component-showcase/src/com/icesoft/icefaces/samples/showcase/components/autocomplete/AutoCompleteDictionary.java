...
public class AutoCompleteDictionary {
    ...
    private static void init() {
        ...
        System.out.println("AutoCompleteDictionary: init()");
        List cityList = null;
...
//                System.out.println("\t got BufferedInputStream");
 //               if (dictionaryStream==null)System.out.println("\t dictionaryStream is null");
                XMLDecoder xDecoder = new XMLDecoder(dictionaryStream);
                // get the city list.
//                System.out.println("\t got xDecoder");
                cityList = (List) xDecoder.readObject();
//                System.out.println("\t got cityList ");
