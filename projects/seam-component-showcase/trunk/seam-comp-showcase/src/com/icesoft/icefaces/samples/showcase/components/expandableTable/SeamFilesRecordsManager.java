...
import org.icefaces.application.showcase.view.bean.examples.component.expandableTable.FilesRecordsManager;
 ...
 */
@Scope(PAGE)
@Name("filesRecordsManager")
public class SeamFilesRecordsManager extends FilesRecordsManager{
