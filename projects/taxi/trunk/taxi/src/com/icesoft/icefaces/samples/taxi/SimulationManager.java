...
public class SimulationManager {
    ...
    private static Logger log = Logger.getLogger(SimulationManager.class.getName());
    ...
    class TaxiClientBot implements Runnable {
        ...
        public void run() {
            try {
                ...
                log.log(Level.INFO, "Taxi Client Bot trouble:", e);
            }
        }
    }
    ...
    class TaxiDriverBot implements Runnable {
        ...
        public void run() {
            try {
                ...
                log.log(Level.INFO, "Taxi Driver Bot trouble:", e);
            }
        }
    }
}
