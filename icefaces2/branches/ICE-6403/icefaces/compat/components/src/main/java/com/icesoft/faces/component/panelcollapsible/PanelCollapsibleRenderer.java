    ...
    public void encodeBegin(FacesContext facesContext, UIComponent uiComponent) throws IOException {
        ...
        if (panelCollapsible.isToggleOnClick() &&
			...
			if (CoreComponentUtils.isJavaScriptDisabled(facesContext)) {
	            ...
	            button.setAttribute(HTML.STYLE_ATTR, "cursor:pointer; border:0px; width:100%; height:16px; background-color:transparent; margin:0; padding:0; font-size: 0; line-height: 0;");
