...
package org.icefaces.demo.auction.stubs;

import org.icefaces.demo.auction.AuctionState;
...
//    private static Log log = LogFactory.getLog(StubServer.class);
    private static Logger log = Logger.getLogger("org.icefaces.demo.auction");

    // Property variables
    public static final String ITEM_PROPERTIES_RESOURCE =
            "org/icefaces/demo/auction/stubs/auction.properties";
    ...
    private void loadItemList() {
        ...
        try {
            ...
            e.printStackTrace();
//            log.log(Level.SEVERE, "Property file \'" + ITEM_PROPERTIES_RESOURCE +
