...
@ResourceDependencies({
        ...
        @ResourceDependency(library = "icefaces.ace", name = "calendar/calendar.js")
})
@ClientBehaviorHolder(events = {"blur", "change", "valueChange", "click", "dblclick", "focus", "keydown", "keypress", "keyup", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "select", "dateSelect"}, defaultEvent = "valueChange")
