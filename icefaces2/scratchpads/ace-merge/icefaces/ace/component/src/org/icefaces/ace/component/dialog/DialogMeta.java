...
public class DialogMeta extends UIPanelMeta {
	...
	@Property(tlddoc="Makes the dialog resizable", defaultValue="true")
	...
	@Property(tlddoc="Width of the element in pixels", defaultValue="300")
	private int width;
	
	@Property(tlddoc="Height of the element in pixels", defaultValue="Integer.MIN_VALUE")
	private int height;
