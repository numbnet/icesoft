...
ice.ace.AjaxUtils = {
    updateElement: function(id, content) {
        $(ice.ace.escapeClientId(id)).replaceWith(content);

        //Mobile
        if($.mobile) {
            var controls = $(ice.ace.escapeClientId(id)).parent().find("input, textarea, select, button, ul");
...
ice.ace.AjaxRequest = function(cfg) {
    ...
    var jsfExecute = cfg.process || '@all';
    var jsfRender = cfg.update || '@all';
