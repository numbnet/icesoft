 ...
 *  InputText Widget
 */
ice.ace.InputText = function(cfg) {
    this.id = cfg.id;
    this.cfg = cfg;
 ...
 */
ice.ace.InputTextarea = function(id, cfg) {
    this.id = id;
    this.cfg = cfg;
    this.jqId = ice.ace.escapeClientId(this.id);
    this.jq = jQuery(this.jqId);
...
/**
 *  SelectOneMenu Widget
 */
ice.ace.SelectOneMenu = function(id, cfg) {
    this.id = id;
    this.cfg = cfg;
    this.jqId = ice.ace.escapeClientId(this.id);
    this.jq = $(this.jqId);
    ...
    //Client Behaviors
    if(this.cfg.behaviors) {
        ice.ace.attachBehaviors(this.input, this.cfg.behaviors);
    }
}

ice.ace.SelectOneMenu.prototype.bindEvents = function() {
...
ice.ace.SelectOneMenu.prototype.show = function() {
...
ice.ace.SelectOneMenu.prototype.hide = function() {
    this.panel.hide();
}

ice.ace.SelectOneMenu.prototype.disable = function() {
    this.disabled = true;
    this.jq.addClass('ui-state-disabled');
}

ice.ace.SelectOneMenu.prototype.enable = function() {
    this.disabled = false;
    this.jq.removeclass('ui-state-disabled');
}

/**
 *  SelectOneRadio Widget
 */
ice.ace.SelectOneRadio = function(cfg) {
    this.id = cfg.id;
    this.cfg = cfg;
    this.jqId = ice.ace.escapeClientId(this.id);
    this.jq = jQuery(this.jqId);
    ...
    this.labels.click(function(e) {
        if(!_self.cfg.disabled) {
            ...
            var element = jQuery(this),
            input = jQuery(ice.ace.escapeClientId(element.attr('for'))),
...
ice.ace.SelectOneRadio.prototype.enable = function() {
    this.jq.find('.ui-radiobutton').removeClass('ui-state-disabled');
    this.cfg.disabled = false;
}

ice.ace.SelectOneRadio.prototype.disable = function() {
    this.jq.find('.ui-radiobutton').addClass('ui-state-disabled');
    this.cfg.disabled = true;
}

/**
 *  SelectBooleanCheckbox Widget
 */
ice.ace.SelectBooleanCheckbox = function(cfg) {
    this.id = cfg.id;
    this.cfg = cfg;
    this.jqId = ice.ace.escapeClientId(this.id);
    this.jq = jQuery(this.jqId);
...
ice.ace.SelectBooleanCheckbox.prototype.isDisabled = function() {
    return this.jq.hasClass('ui-state-disabled');
}

ice.ace.SelectBooleanCheckbox.prototype.enable = function() {
    this.jq.removeClass('ui-state-disabled');
    this.disabled = false;
}

ice.ace.SelectBooleanCheckbox.prototype.disable = function() {
    this.jq.addClass('ui-state-disabled');
    this.disabled = true;
}

/**
 *  SelectManyCheckbox Widget
 */
ice.ace.SelectManyCheckbox = function(cfg) {
    this.id = cfg.id;
    this.cfg = cfg;
    this.jqId = ice.ace.escapeClientId(this.id);
    this.jq = jQuery(this.jqId);
...
ice.ace.SelectManyCheckbox.prototype.enable = function() {
    this.jq.find('.ui-checkbox').removeClass('ui-state-disabled');
    this.cfg.disabled = false;
}

ice.ace.SelectManyCheckbox.prototype.disable = function() {
    this.jq.find('.ui-checkbox').addClass('ui-state-disabled');
    this.cfg.disabled = true;
}

/**
 *  SelectListbox Widget
 */
ice.ace.SelectListbox = function(id, cfg) {
    this.id = id;
    this.cfg = cfg;
    this.jqId = ice.ace.escapeClientId(this.id);
    this.jq = $(this.jqId);
...
ice.ace.SelectListbox.prototype.enable = function() {
    this.jq.removeClass('ui-state-disabled');
    this.cfg.disabled = false;
}

ice.ace.SelectListbox.prototype.disable = function() {
    this.jq.addClass('ui-state-disabled');
    this.cfg.disabled = true;
}