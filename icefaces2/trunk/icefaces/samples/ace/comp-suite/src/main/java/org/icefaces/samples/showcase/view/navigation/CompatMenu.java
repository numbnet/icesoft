...
@Menu(
        title = "menu.compat.title", menuLinks = {
            @MenuLink(title = "menu.compat.autocomplete.title",
                    isDefault = true,
                    exampleBeanName = AutocompleteBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.border.title",
                    exampleBeanName = BorderBean.BEAN_NAME),            
            @MenuLink(title = "menu.compat.calendar.title",
                    exampleBeanName = CalendarBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.chart.title",
                    exampleBeanName = ChartBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.collapsible.title",
                    exampleBeanName = CollapsibleBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.columns.title",
                    exampleBeanName = ColumnsBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.confirmation.title",
                    exampleBeanName = ConfirmationBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.connectionStatus.title",
                    exampleBeanName = ConnectionStatus.BEAN_NAME),
            @MenuLink(title = "menu.compat.dataTable.title",
                    exampleBeanName = DataTableBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.paginator.title",
                    exampleBeanName = PaginatorBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.selector.title",
                    exampleBeanName = SelectorBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.exporter.title",
                    exampleBeanName = ExporterBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.divider.title",
                    exampleBeanName = DividerBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.dragdrop.title",
                    exampleBeanName = DragDropBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.effect.title",
                    exampleBeanName = EffectBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.map.title",
                    exampleBeanName = MapBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.media.title",
                    exampleBeanName = MediaBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.menuBar.title",
                    exampleBeanName = MenuBarBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.menuPopup.title",
                    exampleBeanName = MenuPopupBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.outputResource.title",
                    exampleBeanName = OutputResourceBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.popup.title",
                    exampleBeanName = PopupBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.positioned.title",
                    exampleBeanName = PositionedBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.progress.title",
                    exampleBeanName = ProgressBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.richtext.title",
                    exampleBeanName = RichTextBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.eventphase.title",
                    exampleBeanName = EventPhaseBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.series.title",
                    exampleBeanName = SeriesBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.stacking.title",
                    exampleBeanName = StackingBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.tab.title",
                    exampleBeanName = TabBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.tooltip.title",
                    exampleBeanName = TooltipBean.BEAN_NAME),
            @MenuLink(title = "menu.compat.tree.title",
