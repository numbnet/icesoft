...
//        System.out.println("Slider value changed to: " + event.getNewValue() );
    ...
    public void validateMinValue(FacesContext context, UIComponent component, Object newValue) {
        if (!(maxValue - (Integer) newValue > 3)) {
            throw new ValidatorException(new FacesMessage("Min must be < max by at least 3 units."));
        }
    }
    public void validateMaxValue(FacesContext context, UIComponent component, Object newValue) {
