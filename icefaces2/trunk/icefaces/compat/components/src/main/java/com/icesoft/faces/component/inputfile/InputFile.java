...
//    protected void renderIFrame(Writer writer, BridgeFacesContext context) throws IOException {
    protected void renderIFrame(Writer writer, FacesContext context) throws IOException {
...
//        Node node =  ((DOMResponseWriter) responseWriter).getSavedNode();  // this will be the containing <div>
        Node node = null;
if (true) throw new UnsupportedOperationException("responseWriter.getSavedNode");
        Node copy;
        // #
        if (node != null) {
...
//    private String getUploadServletPath(BridgeFacesContext context) {
    private String getUploadServletPath(FacesContext context) {
