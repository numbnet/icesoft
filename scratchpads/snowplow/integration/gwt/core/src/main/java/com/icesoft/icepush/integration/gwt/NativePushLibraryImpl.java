	...
	public native void init()/*-{
		...
		$wnd.ice.push.gwtRootCallback = function(pushIds){
			for(var i = 0; i < $wnd.ice.push.gwtRegisteredCallbacks.length; i++){
				...
				var listenerId = listener.@com.icesoft.icepush.integration.gwt.PushEventListener::getPushId()();
                            
                	if(listenerId == pushIds){
                    	listener.@com.icesoft.icepush.integration.gwt.PushEventListener::onPushEvent()();
                    }
            }
		}
	}-*/;
