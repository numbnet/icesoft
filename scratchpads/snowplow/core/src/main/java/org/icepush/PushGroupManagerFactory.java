...
public class PushGroupManagerFactory {
    ...
    public static PushGroupManager newPushGroupManager(
                ...
                return
                    (PushGroupManager)
                        _classes[0].
                            ...
                            getConstructor(
                                Observable.class, Observable.class, DefaultConfiguration.class, ServletContext.class).
                            // throws
                            ...
                            newInstance(outboundNotifier, inboundNotifier, configuration, servletContext);
            }
        ...
        return new LocalPushGroupManager(outboundNotifier, inboundNotifier, configuration, servletContext);
    }
}
